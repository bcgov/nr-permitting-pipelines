...
parser.add_argument('mstr_schema')  # positional argument 1
parser.add_argument('app_name')     # positional argument 2
parser.add_argument('-l', '--exec_local',action='store_true')
